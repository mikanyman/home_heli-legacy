...
?>
        <div class="divPage">
            ...
            <ul class="ulMenu">
                    ...
                    <li class="liMenu"><a class="aMenu" href="../rart/index.php"><?php while ($tulosjoukko8 = mysql_fetch_array($kysely8)) { if ($tulosjoukko8["id"] == 8) { print (($tulosjoukko8["sivu_nimi"])); } } ?></a></li>
                </ul>
